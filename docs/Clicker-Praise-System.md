...
- **Puppy detection** is based on the puppy set. A player only counts as a puppy while wearing both the dog ears and the dog tail. The buff is applied only to those who are puppies at the moment the signal is processed.
...
3. **Nearby puppies are detected** - the world is scanned for all players who are currently puppies. A puppy is anyone wearing both the dog ears and the dog tail.
